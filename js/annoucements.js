...
$(document).ready(function () {
    ...
    let fuse = new Fuse(json, options); // "list" is the item array
    ...
    $(".side-scroll-pane-rows").on('click', '.side-row', function () {
        ...
        let entry = findEntryByRow(title.text(), author.text(), date.text(), json);
...
//    alert("the length of json is" + length + " and the title in entry one is: " + json[1].title)
...
// displays the update on the right side
...
// displays the updates on the left
